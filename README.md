...
VIDEO_WORKER_API_URL=https://dashscope-intl.aliyuncs.com/api/v1/services/aigc/video-generation/video-synthesis
VIDEO_API_KEY=
VIDEO_AUTH_SCHEME=Bearer
...
VIDEO_TASK_BASE_URL=https://dashscope-intl.aliyuncs.com/api/v1/tasks
VIDEO_ASYNC_HEADER_NAME=X-DashScope-Async
VIDEO_ASYNC_HEADER_VALUE=enable
VIDEO_IMAGE_HOST_API_URL=https://freeimage.host/api/1/upload
VIDEO_IMAGE_HOST_API_KEY=
VIDEO_IMAGE_HOST_OUTPUT_FIELD=image.url
